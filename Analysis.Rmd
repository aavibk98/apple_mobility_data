...
global_file_to_process <- "data/raw_data/applemobilitytrends-2021-10-02.csv"
...
# create a grouped barplot of the tallied data to include in the knitted
# document, and save that figure to the output/figues directory as a .png file
region_analysis_plot <- long_subset %>%
...
ggsave(plot = region_analysis_plot,
       filename = paste0("output/figures/",
                         core_name,
                         "_",
                         state_no_spaces,
                         "_region_analysis_plot.png"))

region_analysis_plot
```
